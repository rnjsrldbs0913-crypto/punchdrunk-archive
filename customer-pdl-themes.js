(() => {
  ...
  function drawRibbon(width, height, field, time, index) {
    ...
    context.beginPath();
    context.moveTo(-width * 0.22, centerY - thickness * 0.38 - slant * 0.25);
    context.bezierCurveTo(
      width * 0.16,
      centerY - thickness,
      width * 0.62,
      centerY + thickness * 0.08,
      width * 1.2,
      centerY - thickness * 0.48 + slant
    );
    context.lineTo(width * 1.2, centerY + thickness * 0.48 + slant);
    context.bezierCurveTo(
      width * 0.72,
      centerY + thickness,
      width * 0.25,
      centerY - thickness * 0.06,
      -width * 0.22,
      centerY + thickness * 0.42 - slant * 0.25
    );
    context.closePath();
    context.fill();
    context.restore();
